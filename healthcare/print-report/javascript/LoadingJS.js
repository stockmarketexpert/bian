...
"fill :"+this.loadingCaptionColor+";"));img2.setAttribute("style",("position : absolute;"+
"left : 20px;"+
"top : 0;"+
...
"-moz-transform-origin : 0 0;"+
"transform-origin : 0 0;"+
"fill : "+this.loadingCaptionColor+";"));img1.setAttribute("style",("position : absolute;"+
"left : 20px;"+
"top : 0;"+
...
"-moz-transform-origin : 0 0;"+
"transform-origin : 0 0;"+
"fill : "+this.loadingCaptionColor+";"));this.loadBox.appendChild(img1);this.loadBox.appendChild(img2);this.loadBox.appendChild(this.img3);this.instance.appendChild(this.loadBox);},startLoading:function(){},destroy:function(){if(global.isIE8()||global.isIE9()){$(this.bg).animate({"opacity":"0"},0.6,function(){$("body>style").html("");$(this.bg).remove();$("body").css({"background-color":""});}.bind(this));}else{animateOnce($(this.bg),{"opacity":"0"},0.6,function(){$(this.img3).attr("class","");$("body>style").html("");$(this.bg).remove();$(this.image).attr("src","");$("body").css({"background-color":""});}.bind(this));}},initCss:function(){document.getElementsByTagName("html")[0].setAttribute("style",("margin : 0;"+
"padding : 0;"+
"width : 100%;"+
"height : 100%;"));document.body.setAttribute("style",("margin : 0;"+
"padding : 0;"+
"width : 100%;"+
"height : 100%;"+
"position : fixed;"+
"background-color :"+this.loadingBackground+";"));this.bg.setAttribute("style",("margin : 0;"+
"padding : 0;"+
"width : 100%;"+
"height : 100%;"+
"position : fixed;"+
"background-color:"+this.loadingBackground+";"));this.instance.setAttribute("style",("width : 100%;"+
"height : 100%;"+
"opacity : 1;"+
...
"font-family : Tahoma;"+
"position : relative;"));var titleTran="translate(-50%, "+this.loadingSpacing/2+"px)";var loadingBoxTran="translate(-50% , -"+(this.loadingSpacing/2+45)+"px)";var videoImageTran="translate(-50% , -"+(this.loadingSpacing/2+60)+"px)";var imageTran="translate(-50% , 0)";var imageTop="5%";var imageDisplay="block";var loadingPictureHeight=Math.min(window.innerHeight*0.35,this.loadingPictureHeight);if(this.showLoadingGif||this.loadingVideo){if(window.innerHeight<=300)imageDisplay="none";}else{imageTop="50%";imageTran="translate(-50% , -"+(this.loadingSpacing/2+loadingPictureHeight)+"px)";}
if(this.image)this.image.setAttribute("style",("display : "+imageDisplay+";"+
"position : absolute;"+
"top : "+imageTop+";"+
"left : 50%;"+
...
"max-width : 90%;"+
"max-height : 35%;"));this.title.setAttribute("style",("font-family:Arial,Helvetica,sans serif;"+
...
"margin : 0;"+
"padding : 0;"+
"width:90%;"));if(this.videoImage)this.videoImage.setAttribute("style",("position:relative;"+
"cursor:pointer;"+
"display:none;"+
"z-index:4;"+
"perspective:200px;"+
...
"padding : 0;"));if(this.videoLoadImage)
this.videoLoadImage.style["margin-bottom"]=this.loadingSpacing/2+"px";if(this.loadBox)this.loadBox.setAttribute("style",("position:relative;"+
"perspective:200px;"+
"-webkit-transform-style:preserve-3d;"+
"-o-transform-style:preserve-3d;"+
"-ms-transform-style:preserve-3d;"+
